...
class WooyunSaveToLocalPipeline(object):
    def process_item(self,item,spider):
        print "this is dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd"
        #
        ...
        print 'cccccccccccccccccccccccccccccccunchu'
    ...
    def __process_html(self,item):
        ...
        ######看来这个images是内置于item的列表集合，这个里面的信息蛮重要的
        for img in item['images']:
            print 'lllllllllllllllllllllllllllluuuuuuuuuuuuuuuuuuuuuuuuuuuu&&&&&&&&&&&&&&&&&&&'
            print img['path']
            print 'iiiiiiiiiiiiiiiiiiiiiii'
            #处理部份图片存放于http://www.wooyun.org时，使用/upload/..形式的路径
            if img['url'].startswith('http://www.freebuf.com'):
                img['url'] = img['url'].replace('http://www.freebuf.com','')
